...
import styles from "../styles/ConsultationSpecialise.module.css"
import Image from "next/image";
import Link from "next/link";
import { MdPictureAsPdf } from "react-icons/md";


function ConsultationSpecialise(){
  return (
    <>
          ...
          Consultation spécialisée
            <div className="font-medium text-center lowercase" style={{marginLeft:"-66px"}}>
              <div className={styles.desc}>
                <p>
                Notre service de consultations spécialisées réunit une équipe pluridisciplinaire d'experts qui mettent leur savoir-faire approfondi au service du diagnostic et de la prise en charge personnalisée des cas complexes.
                </p>
              </div>
            </div>
          </div>
...
export default ConsultationSpecialise;
...
import styles from "../styles/Ophtamologie.module.css";
import Image from "next/image";
import Link from "next/link";
import { MdPictureAsPdf } from "react-icons/md";

function Ophtamologie() {
  return (
    <>
           ...
           Ophtamologie
            <div className="font-medium text-center lowercase" style={{marginLeft:"-66px"}}>
              <div className={styles.desc}>
                <p>
                Le service d'ophtalmologie prend en charge les pathologies oculaires grâce à une équipe pluridisciplinaire composée de médecins ophtalmologues, de radiologues et de chirurgiens.
                </p>
              </div>
            </div>
          </div>

...
import styles from "../styles/Cardiologie.module.css"
    ...
    <>
      <div id="pediatrie" className={styles.container}>
        ...
        <div className={styles.textContainer}>
          ...
          >
          Cardiologie
            <div className="font-medium text-center lowercase">
              <div className={styles.desc}>
                <p>
                Nos consultations générales offrent des soins de santé complets, de la prévention au diagnostic et au traitement, dans un environnement accueillant et à l'écoute des besoins de chaque patient.
                </p>
              </div>
            </div>
          </div>

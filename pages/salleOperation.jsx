...
import styles from "../styles/Pediatrie.module.css";
import Image from "next/image";
import Link from "next/link";
import { MdPictureAsPdf } from "react-icons/md";


function SalleOperation() {
  return (
    <>
      ...
      Salle D'operation
            <div className="font-medium text-center lowercase" style={{marginLeft:"-66px"}}>
              <div className={styles.desc}>
                <p>
                Notre service pédiatrique s'engage à offrir des soins attentionnés et centrés sur l'enfant, dans un environnement chaleureux, avec des équipes pluridisciplinaires travaillant ensemble pour répondre aux besoins de chaque patient et de sa famille.
                </p>
              </div>
            </div>
          </div>

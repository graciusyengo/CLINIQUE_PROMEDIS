          ...
          >
            ...
            <div className="font-medium text-center lowercase">
              <div className={styles.desc}>
                <p>
                Le service de médecine interne prend en charge les pathologies féminines avec une équipe pluridisciplinaire experte.
                </p>
              </div>
            </div>
          </div>
      ...
      <div>
        <div className={styles.service}>
          <div className={styles.sidebar} >
            ...
            <h5  style={{fontWeight:"600"}}> HISTORIQUE  </h5>
          ...
          >
            <h3 style={{fontSize:"25px",color:"#01405c",fontWeight:"bold"}}> HISTORIQUE</h3>

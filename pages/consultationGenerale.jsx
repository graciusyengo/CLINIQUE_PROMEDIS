...
import styles from "../styles/ConsultationGenerale.module.css";
import Image from "next/image";
import Link from "next/link";
import { MdPictureAsPdf } from "react-icons/md";
import Pdf from "react-to-pdf";

function ConsultationGenerale() {
          ...
          >
            ...
            <div className="font-medium text-center lowercase" style={{marginLeft:"-66px"}}>
              <div className={styles.desc}>
                <p>
                  Nos consultations générales offrent des soins de santé
                  complets, de la prévention au diagnostic et au traitement,
                  dans un environnement accueillant et à l'écoute des besoins de
                  chaque patient.
                </p>
              </div>
            </div>
      ...
      <div>
        <div className={styles.service}>
          ...
          >
            ...
            <p className={styles.paragraphe}>
              Chirurgie gynécologique & mammaire Le service prend en charge les
              pathologies de la femme par une équipe pluridisciplinaire composée
              de médecins, de radiologues, et de chirurgiens.
            </p>
            <p className={styles.paragraphe}>
              Avec une expérience de plus de 30 ans dans les domaines de la
              cancérologie et de la statique pelvienne, l'équipe collabore aussi
              étroitement avec les services de chirurgie digestive, urologique
              et proctologique du groupe hospitalier Diaconesses Croix
              Saint-Simon pour une prise en charge globale des troubles de la
              statique pelvienne et des incontinences urinaires.
            </p>
            <p style={{ textAlign: "justify", width: "800px" }}>
              Le service est expert en chirurgie coelioscopique et robot
              assistée multibras et monotrocart (robot Da Vinci Si de dernière
              génération).
            </p>
            ...
            <p className={styles.paragraphe}>
              Troubles de la statique pelvienne (prolapsus) et incontinence
              urinaire Pathologies utéro-annexielles bénignes (endométriose,
              kystes ovariens, fibromes utérins) Chirurgie de l’infertilité
